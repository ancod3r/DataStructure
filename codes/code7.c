<b>Program to implement multiple stack in a single array.</b>
<pre class="language-c match-braces line-numbers"><code>// This Program is to Implement two Stacks using a Single Array.
#include &lt;stdio.h&gt;
#define SIZE 10
int ar[SIZE];
int top1 = -1;
